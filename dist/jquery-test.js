...
require.define("/index.js",function(require,module,exports,__dirname,__filename,process,global){module.exports = function(inputURL) {
  iimPlay('CODE: CLEAR');
  if ($ !== undefined) {
...
require.define("/test/jquery-test.js",function(require,module,exports,__dirname,__filename,process,global){var should = require('should');
